...
# Rodinia pathfinder
# pathfiner <cols> <rows> <num_threads>
time build/ARM/gem5.opt  -d test/test configs/example/se_SMT_ARM.py 'bmrk_binaries/CRONO/pathfinder 5 5 2' --threadTypes S --cpu=o3_grace_test --mem-type=DDR4_2400_16x4 --mem-size=64GB --mem-channels=2 --num-cpus=1 --smt -t 2 -WThreads 0 -SThreads 2 -FirstThreadSOtherW=True -ROBSize 256 -numSIQEntries 256 -numWIQEntries 10 -numIQEntries 256 -LQEntries 72 -SQEntries 68 -numPhysFloatRegs 280 -numPhysVecRegs 280 -numPhysIntRegs 280


# Rodinia bfs 
# bfs <num threads> input file
time build/ARM/gem5.opt  -d test/test configs/example/se_SMT_ARM.py 'bmrk_binaries/CRONO/bfs 2 graph4096.txt' --threadTypes S --cpu=o3_grace_test --mem-type=DDR4_2400_16x4 --mem-size=64GB --mem-channels=2 --num-cpus=1 --smt -t 2 -WThreads 0 -SThreads 2 -FirstThreadSOtherW=True -ROBSize 256 -numSIQEntries 256 -numWIQEntries 10 -numIQEntries 256 -LQEntries 72 -SQEntries 68 -numPhysFloatRegs 280 -numPhysVecRegs 280 -numPhysIntRegs 280