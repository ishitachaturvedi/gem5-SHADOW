...
def prepareTemplate(outputFile):
    numCores = 1
    #privateL2 = 'l2' in config["system"]["cpu_cluster"][0].keys()
    privateL2 = 'l2' in config["system"]["cpu_cluster"].keys()
    sharedL2 = 'l2_shared' in config["system"].keys()
